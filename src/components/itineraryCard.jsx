...
export default function ItineraryCard({ itinerary }) {
  ...
  return (
    <div
      className="w-[300px] lg:w-[350px] bg-white rounded-xl shadow-md overflow-hidden border 
      transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_20px_50px_rgba(202,138,4,0.5)]"
    >
      {/* Header */}
      <div className="flex items-center p-4">
        ...
        group-hover:scale-140 group-hover:ring-4 group-hover:ring-black/30 group-hover:ring-offset-2"
